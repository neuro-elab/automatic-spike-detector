...
original data. This characteristic improves the interpretability of the results [1]_, [2]_. In many real-world
...
scenarios for methods like PCA and ICA [1]_, [3]_. In [2]_, Lee and Seung, using image data, showed
...
the encodings of the samples [2]_, [4]_.
...
A further result reported by Lee and Seugn in [2]_ is that both the basis vectors and the encodings
...
In [4]_, Brunet et al. introduced NMF as a means of reducing the dimension of expression data from
